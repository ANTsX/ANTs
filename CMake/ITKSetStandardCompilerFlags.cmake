...
macro(check_compiler_platform_flags)
  ...
  if(WIN32)
    if(NOT MINGW)
      if(NOT ${PROJECT_NAME}_ENABLE_VISUAL_STUDIO_DEPRECATED_C_WARNINGS)
        add_definitions(
  ...
  if(WIN32)
    ...
    # This is controlled with ${PROJECT_NAME}_LIBRARY_BUILD_TYPE used in the add_library
    ...
    if(CMAKE_COMPILER_IS_GNUCXX)
      ...
      if(NOT CMAKE_WINDOWS_EXPORT_ALL_SYMBOLS)
        ...
        # turn off BUILD_SHARED_LIBS as ${PROJECT_NAME}_LIBRARY_BUILD_TYPE
  ...
  if(CMAKE_COMPILER_IS_GNUCXX)
    if(APPLE)
      option(
        ${PROJECT_NAME}_USE_64BITS_APPLE_TRUNCATION_WARNING
    ...
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "12")
      set(
        ...
        "${${PROJECT_NAME}_REQUIRED_CXX_FLAGS} -fno-sized-deallocation"
      )
    endif()
  ...
  if(DEFINED ${PROJECT_NAME}_CXX_DISABLE_OPTIMIZATION_FLAG)
    check_cxx_source_compiles(
      ${${PROJECT_NAME}_CXX_DISABLE_OPTIMIZATION_FLAG}
...
if(NOT ${PROJECT_NAME}_C_OPTIMIZATION_FLAGS) #Not set on cmake command line option -D${PROJECT_NAME}_C_OPTIMIZATION_FLAGS:STRING=""
  set(
    ${PROJECT_NAME}_C_OPTIMIZATION_FLAGS
...
if(NOT ${PROJECT_NAME}_CXX_OPTIMIZATION_FLAGS) #Not set on cmake command line option -D${PROJECT_NAME}_CXX_OPTIMIZATION_FLAGS:STRING=""
  set(
    ${PROJECT_NAME}_CXX_OPTIMIZATION_FLAGS
...
# We do not set them in ${PROJECT_NAME}_REQUIRED FLAGS because all project which
...
string(
  ...
  ";"
  CMAKE_C_FLAGS
  "${CMAKE_C_FLAGS} ${${PROJECT_NAME}_C_OPTIMIZATION_FLAGS} ${${PROJECT_NAME}_C_WARNING_FLAGS}"
)
...
string(
  ...
  ";"
  CMAKE_CXX_FLAGS
  "${CMAKE_CXX_FLAGS} ${${PROJECT_NAME}_CXX_OPTIMIZATION_FLAGS} ${${PROJECT_NAME}_CXX_WARNING_FLAGS}"
)
