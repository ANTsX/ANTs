...
int main( int argc, char ** argv )
{
  if ( argc < 4 )
    ...
    std::cerr << argv[0]
              ...
              << "                              May be followed by optional parameters in brackets, e.g., -mrf ICM[beta,iter]."<<endl
              << "                              beta: weight for the MRF prior, must be a non-negative number. Default: 0.1"<<endl
