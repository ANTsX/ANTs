                        ...
                        DerivativeType & /* derivative1 */, DerivativeType & /* derivative2 */)
{
  ...
  double jointPDFValue = pdfinterpolator->Evaluate(pdfind);
  double dJPDF = this->ComputeJointPDFDerivative( pdfind, 0, 0 );
                           ...
                           DerivativeType & /* derivative1 */, DerivativeType & /* derivative2 */)
{
  ...
  this->ComputeJointPDFPoint(fixedImageValue, movingImageValue, pdfind);
  double jointPDFValue = pdfinterpolator->Evaluate(pdfind);
  double dJPDF = this->ComputeJointPDFDerivative( pdfind, 0, 1 );
