...
void InitializeCommandLineOptions( itk::ants::CommandLineParser *sccanparser )
{
...
private:
  ...
  InitializeCommandLineOptions( sccanparser );
  ...
  if( longHelpOption && sccanparser->Convert<unsigned int>( longHelpOption->GetFunction()->GetName() ) == 1 )
    {
