...
KellySlater(std::vector<std::string> args, std::ostream * /*out_stream = nullptr */)
{
  ...
  if (argc < 6)
  {
    std::cout << "Usage:   " << argv[0]
              << " ImageDimension Segmentation.nii.gz WMProb.nii.gz GMProb.nii.gz   Out.nii {GradStep=-0.5}   "
                 "{#Its=50}  {ThickPriorValue=6} {Bool-use-curvature-prior=0} {smoothing=1.5} {BoolUseEuclidean=0}"
              << std::endl;
