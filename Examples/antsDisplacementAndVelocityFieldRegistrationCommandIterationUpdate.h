...
public:
  ...
  typedef itk::ImageToImageMetricComputationTypeTemplatev4
                         <RealType, FixedImageType, MovingImageType>     MetricType;
...
public:
                                  ...
                                  MeasureType & metricValue ) const
  {
    ...
    typedef itk::ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4<MeasureType, FixedImageType, MovingImageType> CorrelationMetricType;
