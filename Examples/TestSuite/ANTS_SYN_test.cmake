...
add_test(NAME ${THIS_TEST_NAME}_JPGINV COMMAND ConvertToJpg ${INVERSEWARP_IMAGE} ${THIS_TEST_NAME}_JPGINV.jpg)
set_property(TEST ${THIS_TEST_NAME}_JPGINV APPEND PROPERTY DEPENDS ${THIS_TEST_NAME}_INVERSEWARP)

# add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP_METRIC_0 COMMAND MeasureImageSimilarity 2 0 ${R64_IMAGE}
...
#
# add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP_METRIC_1 COMMAND MeasureImageSimilarity 2 1 ${R64_IMAGE}
#  ${INVERSEWARP_IMAGE} ${OUTPUT_PREFIX}log.txt ${OUTPUT_PREFIX}metric.nii.gz
#  1.0 0.05)
# set_property(TEST ${THIS_TEST_NAME}_INVERSEWARP_METRIC_1 APPEND PROPERTY DEPENDS ${THIS_TEST_NAME}_INVERSEWARP)
#
# add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP_METRIC_2 COMMAND MeasureImageSimilarity 2 2 ${R64_IMAGE}
#  ${INVERSEWARP_IMAGE} ${OUTPUT_PREFIX}log.txt ${OUTPUT_PREFIX}metric.nii.gz
#  0.37897 0.05)
