...
public:
  ...
  typedef itk::ImageToImageMetricComputationTypeTemplatev4
                <RealType, ImageType, ImageType>                       MetricType;
...
public:
  ...
  void Execute(const itk::Object *, const itk::EventObject & event)
  {
    ...
    if( typeid( event ) == typeid( itk::InitializeEvent ) )
      ...
      typedef itk::GradientDescentOptimizerTemplatev4<ParametersValueType> GradientDescentOptimizerType;
                                  ...
                                  MeasureType & metricValue ) const
  {
    ...
    // images.
    typedef itk::ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4<MeasureType, ImageType, ImageType> CorrelationMetricType;
