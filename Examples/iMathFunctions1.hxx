...
template <class ImageType>
typename ImageType::Pointer
iMathTruncateIntensity( typename ImageType::Pointer image, double lowerQ, double upperQ )
{
  ...
  windowFilter->SetWindowMinimum( lowerQ );
  windowFilter->SetOutputMinimum( lowerQ );
  windowFilter->SetWindowMaximum( upperQ );
  windowFilter->SetOutputMaximum( upperQ );
  windowFilter->Update();
