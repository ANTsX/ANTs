...
int
LandmarkBasedDisplacementFieldTransformInitializer(int argc, char * argv[])
{
  ...
  typename PointSetType::PointsContainerConstIterator mIt = movingCenters->GetPoints()->Begin();
  ...
  {
    typename PointSetType::PointsContainerConstIterator fIt = fixedCenters->GetPoints()->Begin();
...
// 'main()'
int
ANTSUseLandmarkImagesToGetBSplineDisplacementField(std::vector<std::string> args,
