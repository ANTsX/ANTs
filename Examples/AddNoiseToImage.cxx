...
int AddNoise( itk::ants::CommandLineParser *parser )
{
...
void InitializeCommandLineOptions( itk::ants::CommandLineParser *parser )
{
  ...
  {
  std::string description =
    std::string( "Use different noise models each with its own (default) parameters. " );
...
// 'main()'
int AddNoiseToImage( std::vector<std::string> args, std::ostream* /*out_stream = nullptr */ )
{
...
private:
  ...
  std::string commandDescription =
    std::string( "Add various types of noise to an image." );
