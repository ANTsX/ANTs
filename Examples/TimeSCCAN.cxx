...
int timesccan( itk::ants::CommandLineParser *parser )
{
  ...
  itk::ants::CommandLineParser::OptionType::Pointer labels_option =
  ...
  itk::ants::CommandLineParser::OptionType::Pointer size_option =
...
void InitializeCommandLineOptions( itk::ants::CommandLineParser *parser )
{
  ...
  std::string description =
    std::string( "Output is a 2D correlation matrix." );
  OptionType::Pointer option = OptionType::New();
  ...
  {
  std::string description =
    std::string( "Number of consecutive labels in data" );
  OptionType::Pointer option = OptionType::New();
  ...
  option->SetUsageOption(
    0,
    "[four_d_image.nii.gz,three_d_mask.nii.gz]" );
  option->SetDescription( description );
  parser->AddOption( option );
  }
  ...
  {
  std::string description =
    std::string( "takes a labeled (3D) image " )
    + std::string( "and converts it to a 2D matrix csv format as output." );
  ...
  {
  std::string description =
    std::string( "Build the network connectivity matrix" );
  OptionType::Pointer option = OptionType::New();
  option->SetLongName( "network" );
  option->SetUsageOption(
    0,
    "scca[time-matrix.mhd,label-matrix.mhd]" );
  option->SetUsageOption(
    1,
