...
// square image
    ...
    if( ImageDimension == 4 )
      ...
      logfile << myCenterOfMass[0] << "," << myCenterOfMass[1] << "," << myCenterOfMass[2] << ","
              << myCenterOfMass[3] << "," << currentlabel << std::endl;
      }
    labelcount++;
    }
...
int PMSmoothImage(int argc, char *argv[])
{
  ...
  PixelType mytimestep = spacingsize / vcl_pow( 2.0 , (double)(ImageDimension+1) );
  PixelType reftimestep = 0.9 / vcl_pow( 2.0 , (double)(ImageDimension+1) );
