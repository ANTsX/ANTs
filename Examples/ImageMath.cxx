...
extern int ImageMathHelper2D(int argc, char **argv);
extern int ImageMathHelper3D(int argc, char **argv);
extern int ImageMathHelper4D(int argc, char **argv);
...
private:
  ...
  std::cout << "      Usage        : ShiftImageSlicesInTime ImageName shift-amount-default-1 shift-dim-default-last-dim" << std::endl;
    ...
    std::cout
      <<
      "      Usage        : KinematicTensor displacementField whichTensor ["
