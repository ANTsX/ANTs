 ...
 *
 *=========================================================================*/
#ifndef __itkTimeSeriesSimpleSubtractionImageFilter_h
#define __itkTimeSeriesSimpleSubtractionImageFilter_h

#include "itkImageToImageFilter.h"

namespace itk
{
/** \class TimeSeriesSimpleSubtractionImageFilter
...
class ITK_EXPORT TimeSeriesSimpleSubtractionImageFilter :
  public         ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef TimeSeriesSimpleSubtractionImageFilter        Self;
  ...
  itkTypeMacro(TimeSeriesSimpleSubtractionImageFilter, ImageToImageFilter);
...
protected:
  ...
  /** TimeSeriesSimpleSubtractionImageFilter can be implemented as a multithreaded filter.
...
private:
  TimeSeriesSimpleSubtractionImageFilter(const Self &); // purposely not implemented
...
#include "itkTimeSeriesSimpleSubtractionImageFilter.hxx"
#endif
