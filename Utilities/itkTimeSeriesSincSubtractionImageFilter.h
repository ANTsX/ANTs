 ...
 *
 *=========================================================================*/
#ifndef __itkTimeSeriesSincSubtractionImageFilter_h
#define __itkTimeSeriesSincSubtractionImageFilter_h
...
namespace itk
{
/** \class TimeSeriesSincSubtractionImageFilter
 ...
 */
template <class TInputImage, class TOutputImage, unsigned int VRadius = 4>
class ITK_EXPORT TimeSeriesSincSubtractionImageFilter :
  public         ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef TimeSeriesSincSubtractionImageFilter          Self;
  ...
  itkTypeMacro(TimeSeriesSincSubtractionImageFilter, ImageToImageFilter);
  ...
  typedef WindowedSincInterpolateImageFunction<InputImageType, VRadius> InterpolatorType;
  ...
  /** Set/Get ordering of timepoints */
  itkGetMacro(ReverseOrdered, bool);
  itkSetMacro(ReverseOrdered, bool);
...
protected:
  ...
  /** TimeSeriesSincSubtractionImageFilter can be implemented as a multithreaded filter.
...
private:
  TimeSeriesSincSubtractionImageFilter(const Self &); // purposely not implemented
...
#include "itkTimeSeriesSincSubtractionImageFilter.hxx"
#endif
