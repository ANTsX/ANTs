 ...
 *
 *=========================================================================*/
#ifndef __itkTimeSeriesSurroundSubtractionImageFilter_h
#define __itkTimeSeriesSurroundSubtractionImageFilter_h

#include "itkImageToImageFilter.h"

namespace itk
{
/** \class TimeSeriesSurroundSubtractionImageFilter
...
class ITK_EXPORT TimeSeriesSurroundSubtractionImageFilter :
  public         ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef TimeSeriesSurroundSubtractionImageFilter      Self;
  ...
  itkTypeMacro(TimeSeriesSurroundSubtractionImageFilter, ImageToImageFilter);
...
#endif
protected:
  TimeSeriesSurroundSubtractionImageFilter();
  ~TimeSeriesSurroundSubtractionImageFilter()
  {
  }
  ...
  /** TimeSeriesSurroundSubtractionImageFilter can be implemented as a multithreaded filter.
...
private:
  TimeSeriesSurroundSubtractionImageFilter(const Self &); // purposely not implemented
...
#include "itkTimeSeriesSurroundSubtractionImageFilter.hxx"
#endif
