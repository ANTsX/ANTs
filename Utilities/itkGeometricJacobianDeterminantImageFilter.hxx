/*=========================================================================
  ...
  Module:    $RCSfile: itkGeometricJacobianDeterminantImageFilter.hxx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
::InitializeTetrahedralDeltaPoints()
{
  ...
  this->m_DeltaTetrahedralPointA.Fill( 0.0 );
  this->m_DeltaTetrahedralPointB.Fill( 0.0 );
...
::InitializeTriangularDeltaPoints()
{
  ...
  this->m_DeltaTriangularPointA.Fill( 0.0 );
...
template< typename TInputImage, typename TRealType, typename TOutputImage >
typename
GeometricJacobianDeterminantImageFilter< TInputImage, TRealType, TOutputImage >::RealType
GeometricJacobianDeterminantImageFilter< TInputImage, TRealType, TOutputImage >
...
GeometricJacobianDeterminantImageFilter< TInputImage, TRealType, TOutputImage >::RealType
GeometricJacobianDeterminantImageFilter< TInputImage, TRealType, TOutputImage >
::CalculateTriangularArea( PointType a, PointType b, PointType c )
{
