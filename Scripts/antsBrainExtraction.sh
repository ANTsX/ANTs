    ...
    for (( i = 0; i < ${#ANATOMICAL_IMAGES[@]}; i++ ))
      do
        ...
        if [[ ! -f ${N4_CORRECTED_IMAGE} ]];
          then
            logCmd ${ANTSPATH}ImageMath ${DIMENSION} ${N4_TRUNCATED_IMAGE} TruncateImageIntensity ${ANATOMICAL_IMAGES[$i]} 0.01 0.995 256
